...
<body>
    ...
    <main>
        {{-- Título de sección --}}
        <h3 class="section-title">Listado general de usuarios</h3>
        ...
        <table>
            ...
            <tbody>
                @foreach ($usuarios as $u)
                    @php
                        $rating = is_numeric($u->rating_promedio) ? (float) $u->rating_promedio : 0;
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($u->estado === 'activo' || $u->estado === true)
        ...
        <div class="summary-box">
            ...
            <table class="summary-grid">
                <tr>
                    <td class="summary-label" style="width: 25%;">Total de usuarios:</td>
                    <td style="width: 25%;">{{ $usuarios->count() }}</td>
