...
# 🔥 Copiar script laravel-init (LO QUE FALTABA)
COPY docker/laravel-init.sh /var/www/html/docker/laravel-init.sh
RUN chmod +x /var/www/html/docker/laravel-init.sh
